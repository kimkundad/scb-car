                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div style="width:100%; padding-right:10px">
                                    <form action="{{url('admin/users_search')}}" method="GET" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <div class="d-flex">
                                            <input  type="text" class="form-control form-control-solid me-3 flex-grow-1" name="search"  placeholder="ชื่อ - นามสกุล" />
                                    ...
                                    <div style="width:100%">
                                        <form action="{{url('admin/dealer_search')}}" method="GET" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            <div class="d-flex">
                                                <input  type="text" class="form-control form-control-solid me-3 flex-grow-1" name="search" value="{{$search}}" placeholder="Dealer" />
                                                <button type="submit" class="btn btn-primary fw-bold flex-shrink-0" >ค้นหา</button>
                                            </div>
                                        </form>
                                        </div>
