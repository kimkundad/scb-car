                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <div style="width:100%; padding-right:10px">
                                    <form action="{{url('admin/users_search')}}" method="GET" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                        <div class="d-flex">
                                            <input  type="text" class="form-control form-control-solid me-3 flex-grow-1" name="search" value="{{$search}}" placeholder="ชื่อ - นามสกุล" />
                                            <button type="submit" class="btn btn-primary fw-bold flex-shrink-0" >ค้นหา</button>
                                        </div>
                                    </form>
                                    </div>

                                    <div style="width:100%">
                                        <form action="{{url('admin/dealer_search')}}" method="GET" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                            <div class="d-flex">
                                                <input  type="text" class="form-control form-control-solid me-3 flex-grow-1" name="search" placeholder="Dealer" />
                                                <button type="submit" class="btn btn-primary fw-bold flex-shrink-0" >ค้นหา</button>
                                            </div>
                                        </form>
                                        </div>
                                ...
                                <table class="table align-middle gs-0 gy-3">
                                    ...
                                    <thead>
                                        <tr class="fw-bold text-gray-400">
                                            ...
                                            <th class="p-0 "></th>
                                            <th class="p-0 ">Dealer</th>
                                            <th class="p-0 ">Region</th>
                                            <th class="p-0 ">จังหวัด</th>
                                            <th class="p-0 text-end pe-12">Status</th>
                                            <th class="p-0 "></th>
                                        </tr>
                                    </thead>
                                    <!--end::Table head-->
                                            ...
                                            <td>
                                                <div class="d-flex flex-column">
                                                    ...
                                                    <a href="#" class="text-muted text-hover-primary fw-semibold text-muted d-block fs-7">
                                                        <span class="text-dark">No ID</span>: {{ $item->phone }}
                                                    </a>
                                                </div>
                                            </td>
                                            <td>
