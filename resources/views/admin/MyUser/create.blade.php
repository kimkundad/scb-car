                        ...
                        <div class="card card-xl-stretch mb-5 mb-xl-8">
                            ...
                            <div class="card-body border-top p-9">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="name" class="form-control form-control-lg form-control-solid" placeholder="คุณชูชาติ พานทอง" value="{{old('name') ? old('name') : ''}}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <input type="text" name="provider_id" class="form-control form-control-lg form-control-solid" placeholder="บจก. อีซูซุ เสนียนต์" value="{{old('provider_id') ? old('provider_id') : ''}}">
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row fv-plugins-icon-container">
                                        <select class="form-select" name="birthday" aria-label="Select example">
                                            ...
                                            <option value="North East1">North East1</option>
                                            <option value="North East2">North East2</option>
